    ...
    <div>
      ...
      <div className="px-10 text-base mb-8 leading-tight sm:text-sm sm:px-5">
        <p>
          ...
          сети интернет по сетевому адресу https://webstudio-tips.ru.
          <br />
          ...
          пользователях. Находясь на сайте https://webstudio-tips.ru он даёт
          ...
          info@webstudio-tips.ru с пометкой «Актуализация персональных данных».
          <br />
          ...
          info@webstudio-tips.ru с пометкой «Отзыв согласия на обработку
          персональных данных».
          <br />
          ...
          Оператору с помощью электронной почты info@webstudio-tips.ru.
          <br />
          ...
          сети Интернет по адресу https://webstudio-tips.ru/{localActive}
          /privacy.
        </p>
      </div>
