  ...
  return (
    <div>
      ...
      <div className="px-10 text-base mb-8 leading-none sm:text-sm sm:px-5">
        ...
        2.15 На сайте используется Яндекс.Метрика для сбора данных о пользователях<br />
        ...
        12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://webstudio-tips.ru/privacypolicy.</p>
      </div>
      <Footer />
    </div>
  );
